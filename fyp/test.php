      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        <div class="image-slider">
          <div class="product-images">
            ...
            if ($result) {
              if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                  $productImage = "admin/" . $row['product_image_path'];
                  ?>
                  <img src="<?php echo $productImage; ?>" class="<?php if ($srNo == 1) {
                       echo "active";
                     } ?> product-img" alt="" />
                  <?php
                  $srNo++;
            ...
            <!-- <img src="assets/img/jia-2.jpeg" class="product-img" alt="" />
            <img src="assets/img/jia-3.jpeg" class="product-img" alt="" />
            <img src="assets/img/jia-4.jpeg" class="product-img" alt="" /> -->
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-12 col-sm-12">
